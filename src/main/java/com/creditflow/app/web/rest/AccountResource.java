...
import com.creditflow.app.domain.User;
import com.creditflow.app.service.InvalidPasswordException;
import com.creditflow.app.service.MailService;
import com.creditflow.app.service.UserService;
import com.creditflow.app.service.UsernameAlreadyUsedException;
import com.creditflow.app.service.dto.PasswordChangeDTO;
import com.creditflow.app.service.dto.UserDTO;
import com.creditflow.app.web.rest.errors.EmailAlreadyUsedException;
import com.creditflow.app.web.rest.errors.InvalidPasswordWebException;
import com.creditflow.app.web.rest.errors.LoginAlreadyUsedException;
import com.creditflow.app.web.rest.vm.KeyAndPasswordVM;
import com.creditflow.app.web.rest.vm.ManagedUserVM;
...
public class AccountResource {
    ...
    public CompletionStage<Response> registerAccount(@Valid ManagedUserVM managedUserVM) {
        ...
        } catch (com.creditflow.app.service.EmailAlreadyUsedException e) {
            throw new EmailAlreadyUsedException();
        }
    }
